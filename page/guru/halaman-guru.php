  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="dashboard.php">
        ...
        <div class="sidebar-brand-text mx-3">Supervisor Wikrama Bogor</div>
      </a>
      ...
      <li class="nav-item">
        <a class="nav-link" href="?menu=nilai">
          ...
          <span>Uploud Tugas</span></a>
      </li>
      
      <li class="nav-item">
        <a class="nav-link" href="?menu=status">
          <i class="fas fa-fw fa-table"></i>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          ?>
            <marquee><h3>Selamat Datang <?php echo $r['nama']; ?> Sebagai Guru</h3></marquee>
            <?php  } ?>
          <!-- Topbar Navbar -->
