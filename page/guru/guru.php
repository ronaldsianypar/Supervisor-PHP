<?php
 ...
 session_start();
  ...
  if (isset($_POST['simpan'])){
    ...
    $sql = mysqli_query($con, "INSERT INTO tb_uploudTugas VALUES ('','$_POST[mapel]','$namaFile','$_POST[deskripsi]','$_POST[tanggal_uploud]','Ditinjau', ".$_SESSION['idUser'].", '$_POST[tanggal_diperiksa]')");
      if ($sql){
  ...
  if (isset($_POST['update'])) {
    $sql = mysqli_query($con, "UPDATE tb_uploudTugas SET mapel = '$_POST[mapel]', '$namaFile', deskripsi = '$_POST[deskripsi]', tanggal_uploud = '$_POST[tanggal_uploud]', '' WHERE id_tugas = '$_GET[id_tugas]'");
    if ($sql) {
        ...
        <section>
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Upload Tugas</h1>
                        </div>
                        <div class="col-sm-6">
        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <input type="text" name="mapel" class="form-control" placeholder="Mata Pelajaran"  value="<?php echo $isi['mapel'] ?>" required>
                    </div>

                    <div class="col">
                    <label style="text-align:center;">File</label>
                    <input type="file" name="file" class="form-control" placeholder="File"  value="<?php echo $isi['file'] ?>" required>
                    </div>
            </div>
          </div>
          <div class="form-group">
             <div class="row">
               ...
               <div class="col">
                    ...
                    <input type="text" name="deskripsi" class="form-control" placeholder="Deskripsi"  value="<?php echo $isi['deskripsi'] ?>" required>
                    </div>

              <div class="col">
                    <label style="text-align:center;">Tanggal Upload</label>
                    <input type="date" name="tanggal_uploud" class="form-control" placeholder="Tanggal Upload"  value="<?php echo $isi['tanggal_uploud'] ?>" required>
                    </div>
             </div>
                            <!-- /.card-body -->
                    ...
                    <div class="card-body">
                        ...
                        <tbody>
                            <?php 
                                ...
                                $sql = mysqli_query($con, "SELECT * FROM tb_uploudTugas where id_user=".$idUser."");
                                ...
                                <td><a class="btn btn-danger" href="?menu=nilai&hapus&id_tugas=<?php echo $r['id_tugas'] ?>">Hapus</a></td>
                            </tr>
                            <?php  } ?>
                        </tbody>
                        </table>
